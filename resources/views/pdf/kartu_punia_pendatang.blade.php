...
<head>
    <meta charset="utf-8">
    <title>Kartu Punia - {{ $pendatang->nama }} - Tahun {{ $year }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        ...
        <h2>Kartu Punia Krama Tamiu</h2>
        <p>Tahun {{ $year }}</p>
    </div>

    <!-- Info Box -->
    <div class="info-box">
        <p><strong>Nama:</strong> {{ $pendatang->nama }}</p>
        <p><strong>NIK:</strong> {{ $pendatang->nik }}</p>
        <p><strong>Asal:</strong> {{ $pendatang->asal }}</p>
        @if($pendatang->banjar)
        <p><strong>Banjar:</strong> {{ $pendatang->banjar->nama_banjar }}</p>
        @endif
