...
<div class="bg-white min-h-screen">
    ...
    <div class="bg-gradient-to-br from-[#00a6eb] to-[#0090d0] px-4 pt-8 pb-12 text-white relative overflow-hidden">
        ...
        <div class="flex items-center justify-between relative z-10 mb-6">
            ...
            <div class="text-right">
                <div class="text-[9px] text-white/60 uppercase tracking-wider">Kode Tiket</div>
    ...
    <div class="px-4 -mt-6 relative z-10 pb-8">
        ...
        <div id="instructionsView" class="{{ $tiket->status_pembayaran === 'completed' ? 'hidden' : '' }} space-y-4">
            <div class="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
                <div class="p-8 text-center border-b border-slate-100 bg-white">
                    <div class="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 text-[#00a6eb] border border-blue-200 rounded-full text-[10px] font-bold mb-4">
                    ...
                    <div>
                        ...
                        <h2 class="text-3xl font-black text-slate-800">Rp {{ number_format($tiket->total_harga, 0, ',', '.') }}</h2>
                ...
                <div class="p-6 space-y-4">
                    ...
                    @if($is_sandbox && $tiket->status_pembayaran === 'pending' && !$is_ewallet)
...
<script>
    ...
    function checkPaymentStatus() {
        $.get('{{ url("wisata/payment/status?order_id=" . $order_id) }}', function(res) {
            if (res.status === 'completed') {
                // Redirect to ticket success page
                window.location.href = '{{ url("wisata/tiket/success?order_id=" . $order_id) }}';
            }
        });
    }
    ...
    function simulatePayment() {
        ...
        $.ajax({
            url: '{{ url("wisata/payment/simulate") }}',
            method: 'POST',
            data: {
                _token: '{{ csrf_token() }}',
                order_id: '{{ $order_id }}',
