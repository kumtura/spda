 ...
 <div class="row" id="view_berita_div">
            ...
            <table id="ikantable" class="table table-striped table-bordered display no-wrap datatable"
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <!--<td><?php //echo $rows->nama; ?></td>-->
                            <td><a href="<?php echo url('administrator/detail_tenaga_kerja/'.$rows->id_tenaga_kerja); ?>"> <i class="fa fa-eye"></i> Detail </a>  
    ...
    function add_skill(){
        ...
        $.ajax({
            ...
            url:"<?php echo url("administrator/post_data_skill_new"); ?>",
    ...
    jQuery(document).ready(function() {
        ...
        function append_kategori(){
            ...
            $.ajax({
                type:"get",
                url:"<?php echo url('administrator/ambil_listkategori_awal'); ?>",
                data:"",
                dataType:"json",
                success:function(data){
                //console.log("databerita" , data);
        ...
        function editdataModal(value){
            ...
            jQuery.ajax({
                type:"GET",
                url:"<?php echo url('administrator/ambil_listslides/'); ?>"+"/"+value,
                dataType:"json",
                data:"",
                success:function(data){
