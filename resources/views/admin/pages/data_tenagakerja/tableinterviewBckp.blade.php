            ...
            <table id="ikantable" class="table table-striped table-bordered display no-wrap datatable"
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $rows->nama_usaha; ?> <br /> <small>  <?php echo $rows->alamat_banjar; ?></td>
                            <td><?php echo tgl_indo($rows->tanggal_interview); ?> <br /> <small> Pukul : <?php echo $rows->jam; ?></small></td>
                            <!--<td><?php //echo $rows->nama; ?></td>-->
                            <td><a href="<?php echo url('administrator/detail_tenaga_kerja/'.$rows->id_tenaga_kerja); ?>"> <i class="fa fa-eye"></i> Detail </a> </td>
                        </tr>
