...
<div class="row" id="view_berita_div">
  <div class="col-12">
        ...
        ?>
            ...
            <div class="row form-group">
                ...
                <div class="col col-md-2">
                   <div style="visibility:hidden;">Search</div>  <p></p><Button class="btn-primary" onclick="search_data()"> <i class="fa fa-search"></i> Cari Data</Button>
                </div>
            ...
            <?php
                ...
                foreach($datalist as $rows){
                    ...
                    <tbody style="color:#333333;">
                        ...
                        <td> Rp. <?php echo number_format($rows->jumlah_dana,0,',','.'); ?> </td>

                        <td> <?php echo $tgl_bayar; ?> <br />
                            <small> <?php echo $rows->status_bayar; ?> </small> 
                        </td>
                        
                        <td> 
                            <i class="fa fa-eye"></i> &nbsp; Detail Pembayaran <br />
                            <a href="<?php echo url('administrator/detail_usaha/'.$rows->id_usaha); ?>" target="_blank"><i class="fa fa-eye"></i> &nbsp; Detail Usaha </a>
                        </td>
    ...
    function filter_month(index){
        window.location = "<?php echo url('administrator/datapunia_wajib/'); ?>"+"/"+index+"/"+$("#t_date_year").val();
    }
    ...
    function search_data(){
        ...
        window.location = "<?php echo url('administrator/datapunia_wajib/'); ?>"+"/"+index+"/"+$("#t_date_year").val()+"?status="+$("#cmb_status_new").val();
    }
