...
class WartawanControllerAuth extends BaseController
{
    /*
    |--------------------------------------------------------------------------
    | Login Controller
    ...
    */
    ...
    public function runlogin(Request $request){
      ...
      //if($status_pt != '2' && $status_pt != '4' && $status_pt != '0'){
        ...
        if(Auth::guard('wartawan')->attempt(['email' => $request->username, 'password' => $request->password, 'aktif' => '1'])){ 
          ...
          elseif($pt->id_level == "2"){
              $status = "Wartawan";
          }
          elseif($pt->id_level == "4"){
              $status = "Supervisor";
          }
          else{
              $status = "Ketua";
