    ...
    <div class="col-12 col-md-12" style="margin-top:20px;">
        ...
        <div class="row">
            <div class="col col-md-4">
                ...
                <a id="single_image" href="<?php echo url('storage/usaha/icon/'.$rows->logo); ?>"><img src="<?php echo url('storage/karyawan/'.$rows->foto_profile); ?>" id="logo_img_icon" class="img-fluid" /></a> <p></p>
                </div>
                <div class="col-md-12">
                <center>
