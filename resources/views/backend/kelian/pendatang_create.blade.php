...
<div class="bg-white pb-24">
    ...
    <div class="bg-gradient-to-br from-[#00a6eb] to-[#0090d0] px-4 pt-8 pb-12 text-white relative overflow-hidden">
        ...
        <div class="relative z-10">
            <a href="{{ url('administrator/kelian/pendatang') }}" class="inline-flex items-center gap-1 text-white/80 hover:text-white text-xs font-bold transition-colors mb-6 relative z-10">
    ...
    <div class="px-4 -mt-6 relative z-10">
        <form method="POST" action="{{ url('administrator/kelian/pendatang/store') }}" 
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea name="alamat_tinggal" rows="3"
                              ...
                              placeholder="Masukkan alamat tinggal lengkap"></textarea>
                </div>
