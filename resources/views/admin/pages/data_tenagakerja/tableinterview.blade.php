                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9"><input type="text" id="edit_text_title_new" name="edit_text_title_new" required="required" class="form-control" /><small class="form-text text-muted">Masukkan Nama Jabatan</small></div>
                                            </div>
        ...
        <div class="card">
            <div class="card-body">
             ...
             ?>
                 ...
                 <p>&nbsp;</p>
                 <form method="get" action="<?php echo url('administrator/data_tenagakerja_interview'); ?>">
                ...
                <div class="card" style="border:1px solid #e5e5e5;">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <b> <a href="<?php echo url('administrator/detail_tenaga_kerja/'.$rows->id_karyawan); ?>" target="_blank"> <i class="fa fa-eye"></i> </a> </b>
                            </div>
                        </div>  
                        ...
                        <?php
                            if($rows->foto_profile == ""){
                                ...
                                ?>
                                    <img src="<?php echo url('storage/karyawan/'.$rows->foto_profile); ?>" class="img-fluid" style="height:225px; object-fit:cover;  width:100%;  border-radius:50%;" />
                                <?php
                            }
                        ?>
                    </div>
                        ...
                        <small> <?php //echo $rows->no_wa; ?> </small>
                         ...
                         <small style="font-size:12px;"> Tempat InterView :</small> <br />
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <b> <a href="<?php echo url('administrator/detail_usaha/'.$rows->id_usaha); ?>" target="_blank"> <i class="fa fa-eye"></i> </a> </b>
                                </div>
                            </div>
                    </div>
                    ...
                    <div style="float:right; margin-top:20px;">
                            <button class="btn-success form-control" onclick="approve_data('<?php echo $rows->id_jadwal_interview; ?>');"><i class="fa fa-check"></i> Approve</button>
                    </div>

                    <div style="float:right; margin-top:20px; margin-right:20px;">
                            <button class="btn-danger form-control" onclick="approve_data('<?php echo $rows->id_jadwal_interview; ?>');"><i class="fa fa-check"></i> Tolak</button>
                    </div>
                    <br clear="all" />
