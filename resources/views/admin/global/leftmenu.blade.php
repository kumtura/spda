<aside id="sidebar" 
    x-data="{ 
        openSettings: false, 
        openPunia: {{ Request::is('administrator/datapunia_wajib*') || Request::is('administrator/datapunia_pendatang*') || Request::is('administrator/datapunia_usaha*') || Request::is('administrator/setor_punia*') || Request::is('administrator/pengaturan_bagi_hasil*') || Request::is('administrator/kategori_punia*') || Request::is('administrator/alokasi_punia*') || Request::is('administrator/puniapura*') ? 'true' : 'false' }},
         ...
         <li>
          ...
          <li>
            ...
            <ul x-show="openPunia && sidebarOpen" x-transition x-cloak class="py-2 space-y-1 ml-4 border-l border-white/10 pl-2">
                  ...
                  <li><a href="{{ url('administrator/datapunia_usaha') }}" class="flex items-center w-full p-2 text-white/70 hover:text-white transition duration-75 rounded-lg text-xs font-semibold hover:bg-white/5 {{ Request::is('administrator/datapunia_usaha*') ? 'text-white bg-white/5' : '' }}">Iuran Unit Usaha</a></li>
                  ...
                  <li><a href="{{ url('administrator/setor_punia') }}" class="flex items-center w-full p-2 text-white/70 hover:text-white transition duration-75 rounded-lg text-xs font-semibold hover:bg-white/5 {{ Request::is('administrator/setor_punia*') ? 'text-white bg-white/5' : '' }}">Setor & Tarik Punia</a></li>
          ...
          <li>
            ...
            <ul x-show="openTentangDesa && sidebarOpen" x-transition x-cloak class="py-2 space-y-1 ml-4 border-l border-white/10 pl-2">
                  <li><a href="{{ url('administrator/tentang-desa/sejarah') }}" class="flex items-center w-full p-2 text-white/70 hover:text-white transition duration-75 rounded-lg text-xs font-semibold hover:bg-white/5 {{ Request::is('administrator/tentang-desa/sejarah*') ? 'text-white bg-white/5' : '' }}">Sejarah & Pengurus</a></li>
