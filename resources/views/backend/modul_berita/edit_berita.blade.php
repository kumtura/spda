                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <div class="col-lg-12">
                                    ...
                                    <form method="post" enctype="multipart/form-data" id="frm_berita" name="frm_berita" action="<?php echo url('updateberita'); ?>">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                    ...
                                                    -->
                                                    <input type="hidden" name="t_idberita" id="t_idberita" value="<?php echo $data->id_berita; ?>" /> 

                                                    {{ csrf_field() }}
                                                    <div class="row form-group">
                                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Berita</label></div>
                                                        <div class="col-12 col-md-9"><input type="text" id="textinput_berita" name="textinput_berita" required="required" placeholder="" class="form-control" value="<?php echo $data->judul_berita; ?>" /><small class="form-text text-muted">Masukkan Nama Berita</small></div>
                                                    </div>
                                                    ...
                                                    <textarea name="DSC" class="materialize-textarea">
                                                    <?php echo $data->isi_berita; ?></textarea>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Ganti Foto</label></div>
