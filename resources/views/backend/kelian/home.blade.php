...
<div class="px-6 py-4 space-y-8" x-data="{ 
    ...
    <div>
        <div class="grid grid-cols-2 gap-4">
            <a href="{{ url('administrator/kelian/punia') }}" class="bg-white border border-slate-100 p-5 rounded-3xl shadow-sm hover:shadow-md transition-all group">
                ...
                <h3 class="font-bold text-slate-800 text-sm mb-1">Data Punia</h3>
            ...
            <a href="{{ url('administrator/kelian/donasi') }}" class="bg-white border border-slate-100 p-5 rounded-3xl shadow-sm hover:shadow-md transition-all group">
                ...
                <p class="text-slate-400 text-[10px] leading-tight">Monitor Donasi Banjar</p>
            </a>
