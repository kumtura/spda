...
<div id="div_detail_berita" style="display:none;">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" id="judul_berita"> Data Tenaga Kerja Diterima</h4>
                        <hr />
...
<div class="content mt-3" id="div_form_berita" style="display:none;">
    <div class="animated fadeIn">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Data Tenaga Kerja Diterima</strong>
                </div>
                <div class="card-body">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
             ...
             <h4 class="card-title">Data Diterima Karyawan</h4>
            ...
            <center> <small> Total <b style="color:green;"> ( <?php echo count($karyawan); ?> ) </b> Tenaga Kerja sudah bekerja saat ini  </small> </center> 
