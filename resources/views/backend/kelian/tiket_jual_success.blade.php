...
<div class="bg-white min-h-screen pb-24">
    <!-- Header -->
    <div class="bg-linear-to-br from-[#00a6eb] to-[#0090d0] px-5 pt-12 pb-8 text-center">
        ...
        <p class="text-xs text-white/80 font-medium">Pembayaran cash telah dicatat dalam sistem</p>
    </div>
