...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
    <form id="form_maintenance_usaha" name="form_maintenance_usaha" enctype="multipart/form-data" method="post" action="<?php echo url("administrator/submit_post_add_sumbangan"); ?>">
                  ...
                  <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        ...
                        <div id="pngg_jawab">
                            ...
                            <div class="row form-group"  style="margin-top:30px;">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Upload Pembayaran :</label></div>
...
<div class="content mt-3" id="div_form_berita" style="display:none;">
 ...
 <div class="row" id="view_berita_div">
    ...
    <p>&nbsp;</p>
        ...
        <form method="get" name="form_search" url="<?php echo url('administrator/datasumbangan'); ?>">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4">
                <div><button type="button" class="form-control" name="btn_export_pdf" id="btn_export_pdf" onclick="export_pdf();" /> <i class"icon-pdf"></i> Download Laporan</button></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-md-12" style="margin-top:20px; overflow:auto;">
            <table id="ikantable" class="table table-striped table-bordered display no-wrap datatable"
                ...
                <tbody>
                        ...
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><b> <?php echo $nama; ?></b> <br /><small> <?php echo $rows->alamat; ?> </small> </b> </small></td>
                            <td>Rp. <?php echo format_rupiah($rows->nominal); ?> , - <br /><small>Manual Transfer</small><br /><small>Via &raquo; <b> <?php echo $rows->nama_bank; ?> </b> </small></td>
                            <td><?php echo $rows->deskripsi; ?></td>
                            <td><?php echo tgl_indo($tgl[0]); ?></td>
                            <!--<td><?php //echo $rows->nama; ?></td>-->
                            <td><a href="#"> <i class="fa fa-eye"></i> Detail </a> </td>
                        </tr>
